...
Nick Learner        2019-11-13  1.3 Finished implementing ArrayList (untested)
*/

#include "ArrayList.h"

//(1)
ArrayList::ArrayList(): m_size(0), m_maxsize(0), m_array(NULL) { }
...
//(8)
DataType * ArrayList::find(const DataType & target, DataType * & previous, const DataType * start = NULL)
{
	if (m_array[0] == target)
	{
		previous = NULL;
...
void ArrayList::resize(size_t count)
{
	...
	{
		std::cerr << "Error in resizing in resize()\n";
	}
